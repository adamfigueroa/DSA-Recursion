...
function anagrams(str, prefix = ' ') {
  if (str <= 0) {
    ...
    for (let i = 0; i < str.length; i++) {
      let currentCharacter = str.substring(i, i + 1);
      let previousCharacter = str.substring(0, i);
      let remainingCharacter = str.substring(i + 1);
      anagrams(
        previousCharacter + remainingCharacter,
